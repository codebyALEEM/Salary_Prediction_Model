...
model = pickle.load(open(r"C:\Users\VICTUS\Desktop\mastering git\Practise git\ML_Model\Salary_Prediction_Model\linear_regression_model.pkl",'rb'))

# Set the title of the streamlit app
st.title('Salary Prediction App')

# Add a brief description 
st.write('This app predicts the salary based on years of experience using a simplr linear regression model.')
